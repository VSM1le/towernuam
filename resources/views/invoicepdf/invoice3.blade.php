        ...
        <table class="header" style="padding-bottom:15px">
            <tr>
                ...
                <td class="company-details" style="vertical-align: top;">
                    <p style="margin: 0px; font-weight: bold; font-size:24px;line-height:19px;padding-left:19% ">บริษัท นวม จำกัด</p>
                    <p style="margin: 0px; font-weight: bold; font-size:20px;line-height:10px;padding-left:21%">NUAM CO., LTD</p>
