...
<body>
    ...
    <div class="invoice-container">
        ...
        <div class="invoice-details" style="padding-bottom: 8px">
            ...
            <p style="margin: -5px;font-size:24px;line-height:18px"><strong>CREDIT NOTE/ TAX INVOICE</strong></p>
            ...
            <tbody>
                <tr >
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: top; font-size: 18px; ;">
                                    <p style="margin: 0; font-size: 18px; line-height: 0.7;">
                                        เลขที่สัญญา {{ $creditNote->customerrental->customerrental->custr_contract_no_real ?? null}}
                                    </p>
                                </td>
                            </tr>
                        </table>  
                    ...
                    <td style="height: 2px; border:1px solid #000; margin:0px; vertical-align:top">
                        ...
                        <p style="font-size: 18px; line-height:0.8">No.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$creditNote->credit_no}}</p>
                    </td>
                </tr>
                <tr>
                    ...
                    <p style="font-size: 18px">ที่อยู่&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                        {{
                        $creditNote->customer->cust_address_th1
                        }}</p>   
                    <p style="font-size: 18px; line-height:0.8">Address&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        {{
                        $creditNote->customer->cust_address_th2
                        }}
                        {{$creditNote->customer->cust_zipcode}}
                        </p>   
                    </td>
                    <td style="vertical-align:top;width: 40%; border:1px solid #000; margin:0px;">
                        <p style="font-size: 18px; line-height:0.8">วันที่</p>
                        <p style="font-size: 18px; line-height:0.8">Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{  \Carbon\Carbon::parse($creditNote->credit_date)->format('d/m/Y')}}</p>
                    </td>
                </tr>
                <tr>
                ...
                <tr style="height: 200px;">
                   ...
                   <td style="vertical-align: top; width: 100px; text-align: right; border-right: 1px solid #000;">
                        @foreach ( $creditNoteDetails as $detail)
                            <p style="font-size: 18px; margin: 0;">{{ number_format($detail->crd_amt,2,'.',',') }}</p>
                        @endforeach
                    </td> 
                    <td style="text-align: right; border-right:1px solid #000;vertical-align:top;width:100px">
                         @foreach ( $creditNoteDetails as $detail)
                            <p style="font-size: 18px" >{{ number_format($detail->crd_tax_amt,2,'.',',')}}</p>
                        @endforeach
                    </td>
                    <td style="text-align: right; border-right:1px solid #000;vertical-align:top;width:100px">
                         @foreach ( $creditNoteDetails as $detail)
                            <p style="font-size: 18px" >{{ number_format($detail->crd_net_amt,2,'.',',')}}</p>
                        @endforeach
                    </td>
                </tr>
            </tbody>
                   ...
                   <td style="height:100px;border:1px solid #000; vertical-align:top;font-size:18px">
                        <p style="font-size: 18px;line-height:0.8">
                            ...
                            <span style="float: right;clear:both;padding-right:15px">
                                ...
                                {{ number_format($creditNote->creditdetail
                                    ->filter(function ($detail) {
                                        return $detail->crd_tax_amt == 0;
                                    })
                                    ->pluck('crd_amt')
                                    ->sum(), 2, '.', ',') }}
                                @endif
                ...
                <tr style="">
                    ...
                    <td style="border:1px solid #000; text-align:right">
                        <p style="font-size: 18px">
                            @if ($currentPage == $sumPage)
                                {{  number_format($creditNote->creditdetail->pluck('crd_amt')->sum(),2,'.',',') }}
                            @endif
                        </p>
                    </td>
                    <td style="border:1px solid #000; text-align:right">
                    <p style="font-size: 18px">
                            @if ($currentPage == $sumPage)
                                {{  number_format($creditNote->creditdetail->pluck('crd_tax_amt')->sum(),2,'.',',') }}
                            @endif
                    </p>
                    </td>
                    </td>
                    <td style="border:1px solid #000; text-align:right">
                         <p style="font-size: 18px">
                            @if ($currentPage == $sumPage)
                                {{  number_format($creditNote->creditdetail->pluck('crd_net_amt')->sum(),2,'.',',') }}
                            @endif
                        </p> 
                    </td> 
                </tr>
